  ...
  <el-container class="layout-container">
    <el-aside width="240px" class="aside-menu glass-container">
      ...
      >
        ...
        <el-menu-item index="/teacher/grading">试卷批阅</el-menu-item>
      </el-menu>
    </el-aside>
              ...
              <el-dropdown-menu>
                <el-dropdown-item disabled>
                  <div style="text-align:center; padding: 5px 0; line-height: 1.6;">
                    ...
                    <div style="font-size: 12px; color: var(--text-secondary);">{{ user.department || '计算机与信息学院' }}</div>
                    <el-tag size="small" type="success" style="margin-top:2px;">教职工</el-tag>
                  </div>
                </el-dropdown-item>
                <el-dropdown-item divided @click="$router.push('/teacher/profile')">个人资料</el-dropdown-item>
...
<style scoped>
/* 同 StudentLayout 的样式复用 (在实际项目中可提取出 BaseLayout ) */
...
.logo { height: 70px; display: flex; align-items: center; justify-content: center; font-size: 20px; font-weight: 700; color: var(--primary-color); border-bottom: 1px solid var(--glass-border); }
